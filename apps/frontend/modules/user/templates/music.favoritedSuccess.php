...
<div class="content_panel rnd_3">
  <ul class="filters">
    ...
    <li class="show song on" data-target="#song_sb">songs</li>
    <li class="show news future_feature" data-target="#news_sb">news</li>
    <li class="show limelight" data-target="#limelight_sb">limelights</li>
  </ul>
  <ul class="filter_sort_by song on" id="song_sb" data-target=".user_action_feed">
    <li class="head">sorted by</li>
    <li class="on" data-url="<?php echo url_for('user_favorited_more', array('username' => $sf_params->get('username'), 'page' => 1, 'type' => 'song', 'order_by' => 'favorite_date')) ?>">date favorited</li>
    <li data-url="<?php echo url_for('user_favorited_more', array('username' => $user->username, 'page' => 1, 'type' => 'song', 'order_by' => 'submit_date')) ?>">date submitted</li>
    <li data-url="<?php echo url_for('user_favorited_more', array('username' => $sf_params->get('username'), 'page' => 1, 'type' => 'song', 'order_by' => 'score')) ?>">score</li>
    <li data-url="<?php echo url_for('user_favorited_more', array('username' => $sf_params->get('username'), 'page' => 1, 'type' => 'song', 'order_by' => 'plays')) ?>">plays</li>
  </ul>
  <ul class="filter_sort_by news off" id="news_sb" data-target=".user_action_feed">
    <li class="head">sorted by</li>
    <li data-url="<?php echo url_for('user_favorited_more', array('username' => $sf_params->get('username'), 'page' => 1, 'type' => 'news', 'order_by' => 'favorite_date')) ?>">date favorited</li>
