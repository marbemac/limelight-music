...
<div class="feed_filter">
  ...
  <div class="filter_group feed_type rnd_5">
    <a href="<?php echo url_for('feed_song_category', array('category' => $sf_params->get('category', ''))) ?>" class="news xa rnd3_5 <?php echo $filters['feed_type'] == 'Song' ? 'on' : 'hide' ?>" data-value="Song">songs</a>
    <a href="<?php echo url_for('feed_limelight_category', array('category' => $sf_params->get('category', ''))) ?>" class="limelight xa rnd3_5 <?php echo $filters['feed_type'] == 'Limelight' ? 'on' : 'hide' ?>" data-value="Limelight">limelights</a>
  </div>
