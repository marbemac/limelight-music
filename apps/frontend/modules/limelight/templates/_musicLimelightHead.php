...
<div id="ll_head">
  <div id="ll_head_info">
    ...
    <div id="middle" class="rnd_3">
      ...
      <div class="toggle stats future_feature rnd_3" data-target=".stats">stats</div>
    ...
    <div id="bottom">
      <ul class="rnd_3">
        ...
        <li class="<?php echo ($page == 'song') ? 'on' : '' ?>">
          <?php echo link_to('Songs', 'lime_show_songs', array('name_slug' => $limelight['name_slug'])) ?>
          <?php if (isset($limelightStats['new_song_count']) && $limelightStats['new_song_count'] > 0): ?>
            <div class="newCount rnd_3" title="<?php echo $limelightStats['new_song_count'] ?> new songs in the past <?php echo sfConfig::get('app_limelight_head_stat_pullback')/(60*60*24) ?> days"><?php echo $limelightStats['new_song_count'] ?></div>
          <?php endif; ?>
        </li>

        <li class="<?php echo ($page == 'news') ? 'on' : '' ?> future_feature">
          <?php echo link_to('News', '@homepage') ?>
        ...
        <li class="<?php echo ($page == 'concert') ? 'on' : '' ?> future_feature">
          <?php echo link_to('Concerts', '@homepage') ?>
        </li>
