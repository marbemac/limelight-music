...
/**
 * LimelightOwn filter form base class.
 *
 * @package    limelight
 * @subpackage filter
 ...
 */
abstract class BaseLimelightOwnFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('limelight_own_filters[%s]');
