...
/**
 * LimelightReviewProScores filter form base class.
 *
 * @package    limelight
 * @subpackage filter
 ...
 */
abstract class BaseLimelightReviewProScoresFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('limelight_review_pro_scores_filters[%s]');
  ...
  {
    return 'LimelightReviewProScores';
  }
