...
abstract class BaseUserNotificationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_read'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'type'       => new sfValidatorChoice(array('required' => false, 'choices' => array('misc' => 'misc', 'badge' => 'badge', 'moderator' => 'moderator'))),
      'is_read'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
