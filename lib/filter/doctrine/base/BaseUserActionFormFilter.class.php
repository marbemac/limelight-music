...
abstract class BaseUserActionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ItemTag_id'                => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'ItemTag_id'                => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'type'                      => new sfValidatorPass(array('required' => false)),
      'site'                      => new sfValidatorChoice(array('required' => false, 'choices' => array('tech' => 'tech', 'music' => 'music'))),
