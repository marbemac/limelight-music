...
/**
 * LimelightWikiFlags filter form base class.
 *
 * @package    limelight
 * @subpackage filter
 ...
 */
abstract class BaseLimelightWikiFlagsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'limelight_wiki_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('LimelightWiki'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('limelight_wiki_flags_filters[%s]');
