...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'rpx_identifier'            => new sfWidgetFormFilterInput(),
      'rpx_provider_name'         => new sfWidgetFormFilterInput(),
      'username_changed'          => new sfWidgetFormFilterInput(),
      'show_help'                 => new sfWidgetFormFilterInput(),
      'show_welcome_splash'       => new sfWidgetFormFilterInput(),
  ...
  public function addFollowingUsersListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ->leftJoin($query->getRootAlias().'.FollowUserReference FollowUserReference')
      ->andWhereIn('FollowUserReference.user2_id', $values)
    ;
  }

  public function addFollowingLimelightsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('FollowLimelightReference.limelight_id', $values)
    ;
  }
  ...
  public function addFollowersListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.FollowUserReference FollowUserReference')
      ->andWhereIn('FollowUserReference.user1_id', $values)
    ;
  }
  ...
  public function getFields()
  {
    return array(
      ...
      'last_login'                => 'Date',
      'rpx_identifier'            => 'Text',
      'rpx_provider_name'         => 'Text',
      'username_changed'          => 'Text',
      'show_help'                 => 'Text',
      'show_welcome_splash'       => 'Text',
      'created_at'                => 'Date',
      'updated_at'                => 'Date',
      'groups_list'               => 'ManyKey',
      'permissions_list'          => 'ManyKey',
      'following_users_list'      => 'ManyKey',
      'following_limelights_list' => 'ManyKey',
