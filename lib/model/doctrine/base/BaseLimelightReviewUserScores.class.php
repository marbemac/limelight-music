 ...
 * @method LimelightReviewUserScores setCount()               Sets the current record's "count" value
 * @method LimelightReviewUserScores setReviewId()            Sets the current record's "review_id" value
 * @method LimelightReviewUserScores setUserId()              Sets the current record's "user_id" value
 * @method LimelightReviewUserScores setTargetUserId()        Sets the current record's "target_user_id" value
 * @method LimelightReviewUserScores setLimelightReviewUser() Sets the current record's "LimelightReviewUser" value
 * @method LimelightReviewUserScores setRater()               Sets the current record's "Rater" value
 * @method LimelightReviewUserScores setTargetUser()          Sets the current record's "TargetUser" value
 * 
 * @package    limelight
 * @subpackage model
 ...
 */
abstract class BaseLimelightReviewUserScores extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('limelight_review_user_scores');
