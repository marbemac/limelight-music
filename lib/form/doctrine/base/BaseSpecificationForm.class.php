...
/**
 * Specification form base class.
 *
 * @method Specification getObject() Returns the current form's model object
 *
 * @package    limelight
 * @subpackage form
 ...
 */
abstract class BaseSpecificationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Specification', 'column' => array('name_slug')))
    );
