...
/**
 * LimelightSpecFlags form base class.
 *
 * @method LimelightSpecFlags getObject() Returns the current form's model object
 *
 * @package    limelight
 * @subpackage form
 ...
 */
abstract class BaseLimelightSpecFlagsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'limelight_spec_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('LimelightSpec'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('limelight_spec_flags[%s]');
