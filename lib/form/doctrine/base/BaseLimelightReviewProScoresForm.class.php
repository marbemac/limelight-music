...
/**
 * LimelightReviewProScores form base class.
 *
 * @method LimelightReviewProScores getObject() Returns the current form's model object
 *
 * @package    limelight
 * @subpackage form
 ...
 */
abstract class BaseLimelightReviewProScoresForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('limelight_review_pro_scores[%s]');
