...
*
* Tips plugin - Lets you add speech bubble type tips to your tooltips
			...
			update: function(corner, mimic)
			{
				...
				switch(self.method)
				{
					case 'canvas':
						...
						coords = calculate(mimic.string(), width * 2, height * 2);
					...
					case 'vml':
						// Determine tip coordinates based on dimensions
						coords = calculate(mimic.string(), width, height);
